...
// * @author Mohsen Saboorian
// */
//public class LinuxNativeKeyboardListener implements NativeKeyboardListener {
//   private Logger logger = Logger.getLogger(LinuxNativeKeyboardListener.class);
//
//   private List<KeyboardAction> superGlobalActionList = new ArrayList<KeyboardAction>();
//
//   public LinuxNativeKeyboardListener() {
//      try {
//         // Load JNI library
//         System.load(new File("lib/libjxgrabkey.so").getCanonicalPath());
//      } catch (Throwable ex) {
//         try {
//            String jarPath = "jxgrabkey/";
//            String tmpDir = System.getProperty("java.io.tmpdir");
//            try {
//               String dll = "libjxgrabkey.so";
//               fromJarToFs(jarPath + dll, tmpDir + dll);
//               System.load(tmpDir + dll);
//            } catch (UnsatisfiedLinkError e) {
//               String dll = "libjxgrabkey64.so";
//               fromJarToFs(jarPath + dll, tmpDir + dll);
//               System.load(tmpDir + dll);
//            }
//         } catch (Throwable ex2) {
//            throw new ZekrBaseRuntimeException("Could not load JIntellitype.dll from local file system or from inside JAR", ex2);
//         }
//      }
//   }
//
...
//
//               try {
//                  JXGrabKey.getInstance().registerAwtHotkey(superGlobalActionList.size(),
//                        KeyCodeTranslator.translateSWTModifiers(SWT.CTRL), KeyCodeTranslator.translateSWTKey(SWT.F8));
...
//
//      /**
//       * Map of SWT key constants to AWT constants. This is to ensure binary compatibility for existing Swing/AWT apps.
//       */
//      private static int[] translationMap = new int[] { VK_ENTER, SWTVK_ENTER, VK_BACK_SPACE, SWTVK_BACK_SPACE, VK_TAB,
//            SWTVK_TAB, VK_CANCEL, SWTVK_CANCEL, VK_CLEAR, SWTVK_CLEAR, VK_SHIFT, SWTVK_SHIFT, VK_CONTROL, SWTVK_CONTROL, VK_ALT,
//            SWTVK_ALT, VK_PAUSE, SWTVK_PAUSE, VK_CAPS_LOCK, SWTVK_CAPS_LOCK, VK_ESCAPE, SWTVK_ESCAPE, VK_SPACE, SWTVK_SPACE,
//            VK_PAGE_UP, SWTVK_PAGE_UP, VK_PAGE_DOWN, SWTVK_PAGE_DOWN, VK_END, SWTVK_END, VK_HOME, SWTVK_HOME, VK_LEFT,
//            SWTVK_LEFT, VK_UP, SWTVK_UP, VK_RIGHT, SWTVK_RIGHT, VK_DOWN, SWTVK_DOWN, VK_COMMA, SWTVK_COMMA, VK_MINUS,
//            SWTVK_MINUS, VK_PERIOD, SWTVK_PERIOD, VK_SLASH, SWTVK_SLASH, VK_0, SWTVK_0, VK_1, SWTVK_1, VK_2, SWTVK_2, VK_3,
//            SWTVK_3, VK_4, SWTVK_4, VK_5, SWTVK_5, VK_6, SWTVK_6, VK_7, SWTVK_7, VK_8, SWTVK_8, VK_9, SWTVK_9, VK_SEMICOLON,
//            SWTVK_SEMICOLON, VK_EQUALS, SWTVK_EQUALS, VK_A, SWTVK_A, VK_B, SWTVK_B, VK_C, SWTVK_C, VK_D, SWTVK_D, VK_E, SWTVK_E,
//            VK_F, SWTVK_F, VK_G, SWTVK_G, VK_H, SWTVK_H, VK_I, SWTVK_I, VK_J, SWTVK_J, VK_K, SWTVK_K, VK_L, SWTVK_L, VK_M,
//            SWTVK_M, VK_N, SWTVK_N, VK_O, SWTVK_O, VK_P, SWTVK_P, VK_Q, SWTVK_Q, VK_R, SWTVK_R, VK_S, SWTVK_S, VK_T, SWTVK_T,
//            VK_U, SWTVK_U, VK_V, SWTVK_V, VK_W, SWTVK_W, VK_X, SWTVK_X, VK_Y, SWTVK_Y, VK_Z, SWTVK_Z, VK_OPEN_BRACKET,
//            SWTVK_OPEN_BRACKET, VK_BACK_SLASH, SWTVK_BACK_SLASH, VK_CLOSE_BRACKET, SWTVK_CLOSE_BRACKET, VK_NUMPAD0, SWTVK_0,
//            VK_NUMPAD1, SWTVK_1, VK_NUMPAD2, SWTVK_2, VK_NUMPAD3, SWTVK_3, VK_NUMPAD4, SWTVK_4, VK_NUMPAD5, SWTVK_5, VK_NUMPAD6,
//            SWTVK_6, VK_NUMPAD7, SWTVK_7, VK_NUMPAD8, SWTVK_8, VK_NUMPAD9, SWTVK_9, VK_MULTIPLY, SWTVK_MULTIPLY, VK_ADD,
//            SWTVK_ADD, VK_SEPARATOR, SWTVK_SEPARATOR, VK_SUBTRACT, SWTVK_SUBTRACT, VK_DECIMAL, SWTVK_DECIMAL, VK_DIVIDE,
//            SWTVK_DIVIDE, VK_DELETE, SWTVK_DELETE, VK_NUM_LOCK, SWTVK_NUM_LOCK, VK_SCROLL_LOCK, SWTVK_SCROLL_LOCK, VK_F1,
//            SWTVK_F1, VK_F2, SWTVK_F2, VK_F3, SWTVK_F3, VK_F4, SWTVK_F4, VK_F5, SWTVK_F5, VK_F6, SWTVK_F6, VK_F7, SWTVK_F7,
//            VK_F8, SWTVK_F8, VK_F9, SWTVK_F9, VK_F10, SWTVK_F10, VK_F11, SWTVK_F11, VK_F12, SWTVK_F12, VK_PRINTSCREEN,
//            SWTVK_PRINTSCREEN, VK_INSERT, SWTVK_INSERT, VK_HELP, SWTVK_HELP, VK_META, SWTVK_META, VK_BACK_QUOTE,
//            SWTVK_BACK_QUOTE, VK_QUOTE, SWTVK_QUOTE, VK_KP_UP, SWTVK_UP, VK_KP_DOWN, SWTVK_DOWN, VK_KP_LEFT, SWTVK_LEFT,
//            VK_KP_RIGHT, SWTVK_RIGHT, VK_AMPERSAND, SWTVK_AMPERSAND, VK_ASTERISK, SWTVK_ASTERISK, VK_QUOTEDBL, SWTVK_QUOTEDBL,
//            VK_LESS, SWTVK_LESS, VK_GREATER, SWTVK_GREATER, VK_BRACELEFT, SWTVK_BRACELEFT, VK_BRACERIGHT, SWTVK_BRACERIGHT,
//            VK_AT, SWTVK_AT, VK_COLON, SWTVK_COLON, VK_CIRCUMFLEX, SWTVK_CIRCUMFLEX, VK_DOLLAR, SWTVK_DOLLAR, VK_EURO_SIGN,
//            SWTVK_EURO_SIGN, VK_EXCLAMATION_MARK, SWTVK_EXCLAMATION_MARK, VK_INVERTED_EXCLAMATION_MARK,
//            SWTVK_INVERTED_EXCLAMATION_MARK, VK_LEFT_PARENTHESIS, SWTVK_LEFT_PARENTHESIS, VK_NUMBER_SIGN, SWTVK_NUMBER_SIGN,
//            VK_PLUS, SWTVK_PLUS, VK_RIGHT_PARENTHESIS, SWTVK_RIGHT_PARENTHESIS, VK_UNDERSCORE, SWTVK_UNDERSCORE, VK_A,
//            SWTVK_A + 32, VK_B, SWTVK_B + 32, VK_C, SWTVK_C + 32, VK_D, SWTVK_D + 32, VK_E, SWTVK_E + 32, VK_F, SWTVK_F + 32,
//            VK_G, SWTVK_G + 32, VK_H, SWTVK_H + 32, VK_I, SWTVK_I + 32, VK_J, SWTVK_J + 32, VK_K, SWTVK_K + 32, VK_L,
//            SWTVK_L + 32, VK_M, SWTVK_M + 32, VK_N, SWTVK_N + 32, VK_O, SWTVK_O + 32, VK_P, SWTVK_P + 32, VK_Q, SWTVK_Q + 32,
//            VK_R, SWTVK_R + 32, VK_S, SWTVK_S + 32, VK_T, SWTVK_T + 32, VK_U, SWTVK_U + 32, VK_V, SWTVK_V + 32, VK_W,
//            SWTVK_W + 32, VK_X, SWTVK_X + 32, VK_Y, SWTVK_Y + 32, VK_Z, SWTVK_Z + 32, };
//   }
//
//}
