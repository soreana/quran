      ...
      try {
         ...
         shell.addListener(CUSTOM_ZEKR_EVENT, new Listener() {
            public void handleEvent(Event event) {
               if (TRANSLATION_IMPORTED.equals(event.data)
                     || RECITATION_IMPORTED.equals(event.data)
                     || TRANSLATION_REMOVED.equals(event.data)
                     || RECITATION_REMOVED.equals(event.data)) {
                  shell.close();
               }
            }
         });
